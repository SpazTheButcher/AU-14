...
[Serializable, NetSerializable]
public sealed class RMCStimmasterCreateMsg(EntProtoId prototype, int amount) : BoundUserInterfaceMessage
{
...
[Serializable, NetSerializable]
public sealed class RMCStimmasterSelectInjectorMsg(NetEntity injector, bool fill) : BoundUserInterfaceMessage
{
...
[Serializable, NetSerializable]
public sealed class RMCStimmasterSelectAllMsg(bool selectAll) : BoundUserInterfaceMessage
{
    public readonly bool SelectAll = selectAll;
}

[Serializable, NetSerializable]
public sealed class RMCStimmasterFillMsg : BoundUserInterfaceMessage;

[Serializable, NetSerializable]
public sealed class RMCStimmasterLabelMsg(string label) : BoundUserInterfaceMessage
{
    public readonly string Label = label;
}

[Serializable, NetSerializable]
public sealed class RMCStimmasterTransferMsg(NetEntity injector) : BoundUserInterfaceMessage
{
    public readonly NetEntity Injector = injector;
}

[Serializable, NetSerializable]
public sealed class RMCStimmasterEjectMsg(NetEntity injector) : BoundUserInterfaceMessage
{
    public readonly NetEntity Injector = injector;
}
