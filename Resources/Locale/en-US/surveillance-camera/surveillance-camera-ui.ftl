...
surveillance-camera-monitor-ui-status = {$status} {$camera}
...
surveillance-camera-monitor-ui-no-networks = No camera networks
surveillance-camera-monitor-ui-tab-list = List
surveillance-camera-monitor-ui-tab-map = Map
surveillance-camera-monitor-ui-map-empty = No accessible camera map markers
